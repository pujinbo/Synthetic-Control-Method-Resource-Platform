working_dir <- '.'
load(paste0(working_dir, '/generate_data/simulated_data_non_stat_factor.RData'))
...
save.image(file=paste0(working_dir, '/saved_results/varying_T_p10_non_stat.RData'))
