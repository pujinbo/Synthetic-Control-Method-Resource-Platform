...
simulation1 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Polynomial", N=80, T_0=70, alpha=c(0.2,0.3), N_sim=300,sd_Y=0.1)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation2 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Polynomial", N=80, T_0=70, alpha=c(0.2,0.3), N_sim=300,sd_Y=1)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation3 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Cos", N=80, T_0=70, alpha=c(0.2,0.3), sd_Y=0.1,  N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation4 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Cos", N=80, T_0=70, alpha=c(0.2,0.3), sd_Y=1,  N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))

## ARMA components: p = 50 

simulation5 <- simulation_bootstrap_vs_perm_final(p=10, model="Linear_FM", N=80, T_0=70, alpha=c(0.2,0.3), N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation6 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="logit", N=80, T_0=70, alpha=c(0.2,0.3), sd_Y=0.1, N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
print('first set done')
simulation7 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="logit", N=80, T_0=70, alpha=c(0.2,0.3), sd_Y=1, N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation8 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Cos", N=80, T_0=70, alpha=c(0.2,0.3), sd_Y=0.1, N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation9 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Cos", N=80, T_0=70, alpha=c(0.2,0.3), sd_Y=1,  N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation10 <- simulation_bootstrap_vs_perm_final(p=10, model="Factor_model", N=80, T_0=70, alpha=c(0.2,0.3), N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
...
## Low correlation
simulation11 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="logit", N=80, T_0=70, alpha=c(0.2,0.3), model='AR-ARCH', N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation12 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Cos", N=80, T_0=70, alpha=c(0.2,0.3), model='AR-ARCH', N_sim=300)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
simulation13 <- simulation_bootstrap_vs_perm_final(p=10, model_beta="Factor_model", N=80, T_0=70, alpha=c(0.2,0.3),  N_sim=300, non_stationary = T)
save.image(file=paste0(working_dir, '/saved_results/boot_perm_smallN2.RData'))
